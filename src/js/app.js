              ...
              var viewCandidates = `
                <tr>
                  <td class="py-4 px-6 text-gray-300">
                    <input class="form-check-input rounded-full text-blue-600 focus:ring-blue-500" type="radio" name="candidate" value="${id}" id="${id}">
                    <span class="ml-2">${name}</span>
                  </td>
                  <td class="py-4 px-6 text-gray-300">${party}</td>
                  <td class="py-4 px-6 text-gray-300">${voteCount}</td>
                </tr>
              `;
